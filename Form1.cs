    ...
    public partial class Form1 : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (server.start(ipAddress, Convert.ToInt32(nudPort.Value), 100, txtContentPath.Text))
            {
                ...
                MessageBox.Show(this, "Невозможно звпустить север. Быть может порт " + nudPort.Value.ToString() + " занят другой программой.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void Form1_Shown(object sender, EventArgs e)
        {
            ...
            ThreadPool.QueueUserWorkItem((Object arg) =>
            {
                try
                {
                    ...
                    this.Invoke((Action)(() => { ipAddresses.Text = "Внутренний IP: " + System.Net.Dns.GetHostByName(System.Net.Dns.GetHostName()).AddressList[0].ToString() + (externalIP == null ? "" : ", Внешний IP: " + externalIP); }));
                }catch{}
            });
        }
